  ...
  export default {
    ...
    methods: {
      ...
      */
      navigate(obj) {
        ...
        */
        this.$router.push({ name: 'roles.index', query: { page: obj.page } })
        ...
        this.$http.delete(`roles/${role.id}`).then(() => {
          ...
          */
          if (this.isFormVisible) {
            this.$router.push({ name: 'roles.index', query: { page: this.currentPage } })
          }
        })
        .catch((error) => {
          /**
    ...
    */
    computed: {
      ...
      isFormVisible() {
        return this.$route.name === 'roles.new' || this.$route.name === 'roles.edit'
      },
    },
    /**
