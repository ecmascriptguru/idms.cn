    ...
    export default {
        ...
        methods: {
            ...
            fetch() {
                ...
                // this.$http.get(`dct/import/1000`).then((res) => {
                //     const { shop } = res.data.data
                //     this.import.shop = shop
            ...
            update() {
                this.$http.put(`oca/shop/1000`, this.import).then(() => {
                    /**
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <label for="shop" class="control-label">选择文件</label>
                            </div>
                            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                <input type="file" ref="firstInput" name="shop" id="shop" class="form-control" />
                            </div>
                        </div>
